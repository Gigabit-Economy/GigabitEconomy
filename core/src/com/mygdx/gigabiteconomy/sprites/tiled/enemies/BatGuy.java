...
public class BatGuy extends Enemy {
    ...
    public BatGuy(int x, int y, Player targetEntity) {
        super(BASE_PATH, MovingSprite.Weapon.BAT, x, y, 1, 1, targetEntity, 2f, 1.5f, new LinkedList<>(
     ...
     * @param targetEntity
     */
    public BatGuy(int x, int y, Player targetEntity, float deltaHoriz, float deltaVert, LinkedList<MovingSprite.DIRECTION> movementPath) {
        super(BASE_PATH, MovingSprite.Weapon.BAT, x, y, 1, 1, targetEntity, deltaHoriz, deltaVert, movementPath);
    }
}
